...
i2c_bus hw::sensor::left_bus(I2C_NUM_0, GPIO_NUM_18, GPIO_NUM_19);
i2c_bus hw::sensor::right_bus(I2C_NUM_1, GPIO_NUM_5, GPIO_NUM_23);

static_assert(configTICK_RATE_HZ == 1000, "sensor_task requires a 1 ms RTOS tick");
